...
As soluções estão divididas entre as recursivas (Alice, Clean, Clojure, Common Lisp, Elixir, Elm, Erlang, Haskell, Lean, Miranda, Ocaml, Prolog, Racket, Scheme, SML e Yeti) e iterativas (todas as outras linguagens, incluindo F#).
...
The solutions are divided between recursive (Alice, Clean, Clojure, Common Lisp, Elixir, Elm, Erlang, Haskell, Lean, Miranda, Ocaml, Prolog, Racket, Scheme, SML and Yeti) and iterative (all other languages, including F#).
