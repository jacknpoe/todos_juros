...
// Versão 0.1: 22/04/2026: criada a partir da de node.js para Mustache
...
// para enviar os resultados a mustache
const dados = {
    pesoTotal: pesoTotal,
...
<p>Acréscimo: {{acrescimoCalculado}}</p>
<p>Juros: {{jurosCalculado}}</p>
`;

// imprime os resultados
const saida = Mustache.render(template, dados);
console.log(saida);
