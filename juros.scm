...
(define (jurosParaAcrescimo juros)
  (if (or (or (<= juros 0.0d0) (<= Quantidade 0)) (<= Periodo 0.0d0)) (return-from jurosParaAcrescimo 0.0d0))
  (if (<= (getPesoTotal) 0.0d0) (return-from jurosParaAcrescimo 0.0d0))
  (if (= Composto 1)
...
(define (acrescimoParaJuros acrescimo precisao maxIteracoes maxJuros)
  (if (or (or (or (or (or (<= acrescimo 0.0d0) (<= Quantidade 0)) (<= Periodo 0.0d0)) (< maxIteracoes 1)) (< precisao 1)) (<= maxJuros 0.0d0)) (return-from acrescimoParaJuros 0.0d0))
  (if (<= (getPesoTotal) 0.0d0) (return-from acrescimoParaJuros 0.0d0))
