Module Program
  ...
  Sub Main(args as String())
    ...
    For Indice As Integer = 0 To 2
      meuJuros.Pagamentos(Indice) = 30.0 * (Indice + 1.0)
      meuJuros.Pesos(Indice) = 1.0
    Next Indice

    Console.WriteLine("Peso total = {0}", meuJuros.GetPesoTotal)
    Console.WriteLine("Acrescimo = {0}", meuJuros.JurosParaAcrescimo(3.0))
    Console.WriteLine("Juros = {0}", meuJuros.AcrescimoParaJuros(meuJuros.JurosParaAcrescimo(3.0), 15, 100, 50.0))
  End Sub
