...
Two concepts that weighed heavily were floating-point number exponentiation (direct or implemented, it is used in all dialects) and dynamic arrays (which were not possible in some dialects; in these cases, the arrays could have three or a thousand elements).
...
The solutions are divided between recursive and iterative methods, forming two very distinct algorithmic sets. In the list found at [SOLUCOES.md](SOLUCOES.md), recursive solutions have the ♻️ badge.
...
Some files are unreadable, as they are binary and must be opened or imported into the dialect environments, such as AppleSoft BASIC, Smalltalk, Snap! and twinBASIC. StarLogo Nova does not save to a file, so only the URL is available: [https://www.slnova.org/jacknpoe/projects/941781/](https://www.slnova.org/jacknpoe/projects/941781/). The MakeCode Arcade version is also available online at [https://arcade.makecode.com/S46829-97315-00721-56883](https://arcade.makecode.com/S46829-97315-00721-56883).
