...
As soluções estão divididas entre as recursivas (Clojure, Common Lisp, Elixir, Erlang, Haskell, Ocaml, Prolog, Racket, Scheme e Yeti) e iterativas (todas as outras linguagens, incluindo F#).
...
The solutions are divided between recursive (Clojure, Common Lisp, Elixir, Erlang, Haskell, Ocaml, Prolog, Racket, Scheme and Yeti) and iterative (all other languages, including F#).
