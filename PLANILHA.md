...
O cálculo dos juros a partir do acréscimo (`acrescimoParaJuros`) deve ser feito usando a linha `Atingir`. Coloque o valor desejado em `Juros Simples` ou `Juros Compostos`, e clique no botão correspondente, abaixo do valor.
