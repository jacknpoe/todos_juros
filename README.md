...
Alguns arquivos estão ilegíveis, pois são binários e devem ser abertos ou importandos no ambiente das linguagens, como Smalltalk, Snap! e GW-BASIC.
...
Some files are unreadable, as they are binary and must be opened or imported into the language environment, such as Smalltalk, Snap! and GW-BASIC.
