...
// RESULTADOS: calcular e medir 1000x resultou em uma média de 0,063 s, equivalente a 0,000063 s por chamada a
//             `jurosParaAcrescimo()` e `acrescimoParaJuros()`, ~317,5 mais rápido do que juros_otimizado.c.
