...
As soluções estão divididas entre as recursivas (Alice, Bend, Clean, Clojure, Common Lisp, DataWeave, Elixir, Elm, Erlang, Haskell, Idris, Lean, Miranda, OCaml, Prolog, PureScript, Racket, ReasonML, ReScript, Scheme, SML, Squint e Yeti) e iterativas (todas as outras linguagens, incluindo F#).
...
The solutions are divided between recursive (Alice, Bend, Clean, Clojure, Common Lisp, DataWeave, Elixir, Elm, Erlang, Haskell, Idris, Lean, Miranda, OCaml, Prolog, PureScript, Racket, ReasonML, ReScript, Scheme, SML, Squint and Yeti) and iterative (all other languages, including F#).
