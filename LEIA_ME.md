...
As soluções estão divididas entre as recursivas e iterativas, formando dois conjuntos algorítmicos bem distintos. Na lista encontrada em [SOLUCOES.md](SOLUCOES.md), as soluções recursivas têm o selo ♻️.
