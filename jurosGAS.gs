...
// Versão 0.1: 18/03/2025: versão de testes a partir da de Node.js
...
Logger.log( "Peso total = " + pesoTotal)
Logger.log( "Acréscimo = " + acrescimoCalculado)
Logger.log( "Juros = " + jurosCalculado)// Cálculo do juros, sendo que precisa de arrays pra isso
// Versão 0.1: 18/03/2025: versão de testes a partir da de Node.js
...
function main() {
  ...
  Logger.log( "Peso total = " + pesoTotal)
  Logger.log( "Acréscimo = " + acrescimoCalculado)
  Logger.log( "Juros = " + jurosCalculado)
}