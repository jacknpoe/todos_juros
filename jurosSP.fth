...
\        0.2: 06/05/2026: agora PRECISAO é int e POWINT calcula MINDIFERENCA em laço
...
\ calcula base float ^ expoente int
FVARIABLE PIEXPOENTE
FVARIABLE PIBASE
FVARIABLE PIPRODUTO
: POWINT ( F: BASE  D: EXPOENTE -- PRODUTO )
    PIEXPOENTE !
    PIBASE F!
	1.0e PIPRODUTO F!
	PIEXPOENTE @ 0 DO
		PIBASE F@ PIPRODUTO F@ F* PIPRODUTO F!
	LOOP
	PIPRODUTO F@
;
...
: ACRESCIMOPARAJUROS ( F: ACRESCIMO MAXJUROS  D: PRECISAO MAXITERACOES -- JUROS )
    PJAMAXITERACOES !
    PJAPRECISAO !
    PJAMAXJUROS F!
    PJAACRESCIMO F!
    GETPESOTOTAL PJAPESOTOTAL F!
    QUANTIDADE @ 1 < PERIODO F@ 0.0e F< PJAACRESCIMO F@ 0.0e F< PJAPRECISAO @ 1 < PJAMAXITERACOES @ 1 < PJAMAXJUROS F@ 0.0e F< PJAPESOTOTAL F@ 0.0e F< OR OR OR OR OR OR
    IF
        0.0e
    ELSE
        0.0e PJAMINJUROS F!
        PJAMAXJUROS F@ 2.0e F/ PJAMEDJUROS F!
        0.1e PJAPRECISAO @ POWINT PJAMINDIFERENCA F!
        0 PJAITERACAO !
        BEGIN
...
ACRESCIMOCALCULADO F@ 50.0e 15 100 ACRESCIMOPARAJUROS JUROSCALCULADO F!
