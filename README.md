...
Alguns dialetos tiveram o tempo medido para 300.000 parcelas, e classificados: [benchmark.png](https://github.com/jacknpoe/todos_juros/blob/main/benchmark.png). Existem duas versões em C, a versão para comparação justa, com os mesmos algoritmos dos demais dialetos, e a versão otimizada.
...
Some dialects had their time measured for 300,000 installments and ranked: [benchmark.png](https://github.com/jacknpoe/todos_juros/blob/main/benchmark.png). There are two versions in C, the version for fair comparison, with the same algorithms as the other dialects, and the optimized version.
