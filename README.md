...
As soluções estão divididas entre as recursivas (Clojure, Common Lisp, Elixir, Elm, Erlang, Haskell, Lean, Ocaml, Prolog, Racket, Scheme, SML e Yeti) e iterativas (todas as outras linguagens, incluindo F#).
...
The solutions are divided between recursive (Clojure, Common Lisp, Elixir, Elm, Erlang, Haskell, Lean, Ocaml, Prolog, Racket, Scheme, SML and Yeti) and iterative (all other languages, including F#).
