...
// Versão 0.1: 11/02/2025: versão de testes a partir da de Node.js
...
export default function App() {
  ...
  return (
    <View>
      <Text>Peso total = {pesoTotal}</Text>
      <Text>Acréscimo = {acrescimoCalculado}</Text>
      <Text>Juros = {jurosCalculado}</Text>
    </View>
  );
}